...
// WithTitle adds the title to the list params
func (o *ListParams) WithTitle(title *string) *ListParams {
	o.SetTitle(title)
	return o
}

// SetTitle adds the title to the list params
func (o *ListParams) SetTitle(title *string) {
	o.Title = title
}
